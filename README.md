...
### 🔹 Array Programs (1D & 2D)

* `Arrays.c`
* `Array Operations.c`
* `Sum and Average Array.c`
* `Reverse Array.cpp`
* `Remove Duplicate.c`
* `Unique Check.c`
* `GCD Array.c`
